    ...
    <div class="min-w-xl rounded overflow-hidden shadow-lg" style="width:100%;margin-left:1rem;">
        <form class="w-full min-w-lg" style="margin:2rem;" action="create-content" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex items-center border-b border-b-2 border-teal-500 py-2" style="width:70%;">
                <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Title" aria-label="Full name">
            </div>
            <br>
            <br>
            <br>
            ...
            <br>
            <div class="flex items-center border-b border-b-2 border-teal-500 py-2" style="width:70%;">
                <textarea class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Jane Doe" aria-label="Full name">
                </textarea>
            </div>
            <br>
            <br>
